...
from pyEcoHAB import Loader, SetupConfig, Timeline, data_path, sample_data
...
class TestCheckTwoMice(unittest.TestCase):
    ...
    def test_lab_pushing_mouse2_pushing_mouse1(self):
        ...
        out = tubed.does_mouse1_push_out(
            m1_antennas, m1_times, m2_antennas, m2_times, self.config
        )
    ...
    def test_mouse_simple_pushing_mouse2(self):
        ...
        out = tubed.does_mouse1_push_out(
            m1_antenna, m1_times, m2_antenna, m2_times, self.config
        )
        self.assertTrue(out)
...
class TestCheckMousePushingOut(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.config = SetupConfig(path=data_path, fname="standard_setup.txt")
    ...
    def test_lab_pushing_mouse2_pushing_mouse1(self):
        ...
        out = tubed.check_mouse1_pushing(
            m1_antennas, m1_times, m2_antennas, m2_times, self.config
        )
