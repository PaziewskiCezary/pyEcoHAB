...
class TestExpectedTimeTogether(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.duration = 100
        cls.out1, cls.out2 = ics.mice_together(
            cls.data, "mouse1", "mouse2", ["A", "B", "C", "D"], cls.duration
        )
...
class TestSinglePhaseResults(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        data = Loader(path)
        cls.phases, cls.total_time, cls.data, cls.keys = utils.prepare_binned_data(
            data, cls.config, cls.duration, ["mouse_1", "mouse_2"]
        )
        DD = 984.282 * 671.526
        AA = 326.757 * 254.848
        D = 84.312
        ...
        cls.out, cls.exp = ics.single_phase_results(
            cls.data["1 dark"][0],
            ["mouse_1", "mouse_2"],
            ["cage A", "cage D"],
            cls.duration,
        )
        cls.out_A, cls.exp_A = ics.single_phase_results(
            cls.data["1 dark"][0], ["mouse_1", "mouse_2"], ["cage A"], cls.duration
        )
        cls.correct_res_A = {
            "mouse_1": {
                "mouse_1": 0,
    ...
    def test_exp_A_1_1(self):
        self.assertEqual(
            self.correct_exp_res_A["mouse_1"]["mouse_1"],
            self.exp_A["mouse_1"]["mouse_1"],
        )

    def test_exp_A_1_2(self):
        out = np.isclose(
            self.correct_exp_res_A["mouse_1"]["mouse_2"],
    ...
    def test_exp_A_2_1(self):
        self.assertEqual(
            self.correct_exp_res_A["mouse_2"]["mouse_1"],
            self.exp_A["mouse_2"]["mouse_1"],
        )

    def test_exp_A_2_2(self):
        self.assertEqual(
            self.correct_exp_res_A["mouse_2"]["mouse_2"],
            self.exp_A["mouse_2"]["mouse_2"],
        )

    def test_A_1_1(self):
        self.assertEqual(
            self.correct_res_A["mouse_1"]["mouse_1"], self.out_A["mouse_1"]["mouse_1"]
        )

    def test_A_1_2(self):
        self.assertTrue(
            np.isclose(
                self.correct_res_A["mouse_1"]["mouse_2"],
    ...
    def test_A_2_1(self):
        self.assertEqual(
            self.correct_res_A["mouse_2"]["mouse_1"], self.out_A["mouse_2"]["mouse_1"]
        )

    def test_A_2_2(self):
        self.assertEqual(
            self.correct_res_A["mouse_2"]["mouse_2"], self.out_A["mouse_2"]["mouse_2"]
        )

    def test_exp_1_1(self):
        self.assertEqual(
            self.correct_exp_res["mouse_1"]["mouse_1"], self.exp["mouse_1"]["mouse_1"]
        )

    def test_exp_1_2(self):
        self.assertTrue(
            np.isclose(
                self.correct_exp_res["mouse_1"]["mouse_2"],
    ...
    def test_exp_2_1(self):
        self.assertEqual(
            self.correct_exp_res["mouse_2"]["mouse_1"], self.exp_A["mouse_2"]["mouse_1"]
        )

    def test_exp_A_2_2(self):
        self.assertEqual(
            self.correct_exp_res_A["mouse_2"]["mouse_2"], self.exp["mouse_2"]["mouse_2"]
        )

    def test_1_1(self):
        self.assertEqual(
            self.correct_res["mouse_1"]["mouse_1"], self.out["mouse_1"]["mouse_1"]
        )

    def test_1_2(self):
        self.assertTrue(
            np.isclose(
                self.correct_res["mouse_1"]["mouse_2"], self.out["mouse_1"]["mouse_2"]
            )
        )

    def test_2_1(self):
        self.assertEqual(
            self.correct_res["mouse_2"]["mouse_1"], self.out["mouse_2"]["mouse_1"]
        )

    def test_2_2(self):
        self.assertEqual(
            self.correct_res["mouse_2"]["mouse_2"], self.out["mouse_2"]["mouse_2"]
        )
